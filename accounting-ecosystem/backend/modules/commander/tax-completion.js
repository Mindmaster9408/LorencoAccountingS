...
async function _verifyPack(id, cid) {
    const { data } = await supabase
        .from('commander_tax_completion_packs')
        .select('*')
        .eq('id', id)
        .eq('company_id', cid)
        .maybeSingle();
...
async function _verifyItem(itemId, packId, cid) {
    const { data } = await supabase
        .from('commander_tax_completion_items')
        .select('*')
        .eq('id', itemId)
...
async function _writeEvent(packId, cid, eventType, oldStatus, newStatus, userId, notes, meta) {
    await supabase.from('commander_tax_completion_events').insert({
...
// Enrich a list of packs with client_name from commander_clients.
...
async function _runQualityGate(pack, cid, items) {
    ...
    const { data: lines } = await supabase
        .from('commander_sars_statement_lines')
    ...
    const { data: disputes } = await supabase
        .from('commander_tax_dispute_cases')
...
router.get('/summary', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/tax-completion/summary', err);
...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/tax-completion', err);
...
router.post('/create-from-submission', async (req, res) => {
    ...
    try {
        ...
        const { data: submission } = await supabase
            .from('commander_tax_submissions')
        ...
        if (defaults.length > 0) {
            await supabase.from('commander_tax_completion_items').insert(
        ...
        console.error('POST /api/commander/tax-completion/create-from-submission', err);
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/tax-completion', err);
...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/tax-completion/:id', err);
...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/tax-completion/:id', err);
...
router.delete('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/tax-completion/:id', err);
...
router.post('/:id/generate-default-items', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/tax-completion/:id/generate-default-items', err);
...
router.post('/:id/recalculate-score', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/tax-completion/:id/recalculate-score', err);
...
router.put('/:id/submit-review', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/tax-completion/:id/submit-review', err);
...
router.put('/:id/approve', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/tax-completion/:id/approve', err);
...
router.put('/:id/complete', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/tax-completion/:id/complete', err);
...
router.put('/:id/partner-override', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/tax-completion/:id/partner-override', err);
...
router.get('/:id/items', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/tax-completion/:id/items', err);
...
router.post('/:id/items', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/tax-completion/:id/items', err);
...
router.put('/:id/items/:itemId', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/tax-completion/:id/items/:itemId', err);
...
router.delete('/:id/items/:itemId', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/tax-completion/:id/items/:itemId', err);
...
router.get('/:id/events', async (req, res) => {
    ...
    try {
        ...
        const { data: events, error } = await supabase
            .from('commander_tax_completion_events')
            .select('*')
            .eq('completion_pack_id', pack.id)
            .eq('company_id', cid)
        ...
        console.error('GET /api/commander/tax-completion/:id/events', err);
