/* =============================================================
   ...
   Mounted at /api/commander/taxpayer-profiles
   ============================================================= */
'use strict';
...
router.post('/', async (req, res) => {
    ...
    const [clientOk, respOk, reviewerOk] = await Promise.all([
        ...
        verifyBelongsToCompany(cid, 'commander_team_members', responsible_team_member_id),
    ...
    await auditFromReq(req, 'CREATE', 'commander_taxpayer_profile', data.id, {
        module: 'commander', action: 'taxpayer_profile_created', taxpayer_type,
    });
...
router.put('/:id', async (req, res) => {
    ...
    await auditFromReq(req, 'UPDATE', 'commander_taxpayer_profile', data.id, {
        module: 'commander', action: 'taxpayer_profile_updated',
    });
...
router.delete('/:id', async (req, res) => {
    ...
    await auditFromReq(req, 'UPDATE', 'commander_taxpayer_profile', parseInt(req.params.id), {
        module: 'commander', action: 'taxpayer_profile_ceased',
    });
...
router.get('/:id/income-sources', async (req, res) => {
    ...
    const { data, error } = await supabase
        .from('commander_taxpayer_income_sources')
        .select('*')
...
router.post('/:id/income-sources', async (req, res) => {
    ...
    await auditFromReq(req, 'CREATE', 'commander_taxpayer_income_source', data.id, {
        module: 'commander', action: 'taxpayer_income_source_added', profile_id: profileId,
    });
...
router.get('/:id/deductions', async (req, res) => {
    ...
    const { data, error } = await supabase
        .from('commander_taxpayer_deductions')
        .select('*')
        .eq('profile_id', req.params.id)
        .eq('company_id', cid)
        .order('created_at');
...
router.post('/:id/deductions', async (req, res) => {
    ...
    await auditFromReq(req, 'CREATE', 'commander_taxpayer_deduction', data.id, {
        module: 'commander', action: 'taxpayer_deduction_added', profile_id: profileId,
    });
...
router.get('/:id/readiness', async (req, res) => {
    ...
    const { data, error } = await supabase
        .from('commander_taxpayer_readiness_items')
        .select('*')
...
router.post('/:id/recalculate-readiness', async (req, res) => {
    ...
    await auditFromReq(req, 'UPDATE', 'commander_taxpayer_profile', data.id, {
        module: 'commander', action: 'taxpayer_profile_readiness_recalculated', score, readiness_status,
    });
...
router.post('/:id/generate-default-items', async (req, res) => {
    ...
    await auditFromReq(req, 'CREATE', 'commander_taxpayer_readiness_item', profileId, {
        module: 'commander', action: 'taxpayer_defaults_generated',
