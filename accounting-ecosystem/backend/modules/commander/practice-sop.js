...
// review_task has no dedicated table — review tasks are commander_tasks rows
// with review_required = true, so it maps to the same table as 'task'.
const LINKED_TYPE_TABLE = {
    workflow_template: 'commander_workflow_templates',
    workflow_step:     'commander_workflow_template_steps',
    task:              'commander_tasks',
    review_task:       'commander_tasks',
...
async function _writeEvent(sopId, cid, eventType, oldStatus, newStatus, userId, notes, meta) {
    await supabase.from('commander_sop_events').insert({
        sop_id:        sopId,
        company_id:    cid,
...
router.get('/summary', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/sop/summary', err);
...
router.get('/linked/:linkedType/:linkedId', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/sop/linked/:linkedType/:linkedId', err);
...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/sop', err);
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/sop', err);
...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/sop/:id', err);
...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/sop/:id', err);
...
router.delete('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/sop/:id', err);
...
router.put('/:id/submit-review', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/sop/:id/submit-review', err);
...
router.put('/:id/approve', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/sop/:id/approve', err);
...
router.get('/:id/links', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/sop/:id/links', err);
...
router.post('/:id/links', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/sop/:id/links', err);
...
router.delete('/:id/links/:linkId', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/sop/:id/links/:linkId', err);
...
router.get('/:id/events', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/sop/:id/events', err);
