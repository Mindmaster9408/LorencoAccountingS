...
const LINKED_TYPE_TABLE = {
    ...
    workflow:        'commander_workflow_runs',
    completion_pack: 'commander_tax_completion_packs',
    sop:             'commander_sop_templates',
};
...
async function _verifyFinding(findingId, cid) {
    const { data } = await supabase
        .from('commander_quality_findings')
        .select('*')
        .eq('id', findingId)
        .eq('company_id', cid)
        .maybeSingle();
...
async function _writeEvent(reviewId, findingId, cid, eventType, oldStatus, newStatus, userId, notes, meta) {
    await supabase.from('commander_quality_events').insert({
        review_id:     reviewId,
...
// Enrich a list of reviews with client_name from commander_clients.
...
router.get('/summary', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/qms/summary', err);
...
router.get('/reviews', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/qms/reviews', err);
...
router.post('/reviews', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/qms/reviews', err);
...
async function _createFromSource(req, res, opts) {
    ...
    try {
        ...
        console.error(`POST /api/commander/qms/create-from-${linkedType}`, err);
...
router.post('/create-from-task', (req, res) => _createFromSource(req, res, {
    sourceIdField: 'task_id', sourceTable: 'commander_tasks', linkedType: 'task',
...
router.post('/create-from-workflow', (req, res) => _createFromSource(req, res, {
    sourceIdField: 'workflow_run_id', sourceTable: 'commander_workflow_runs', linkedType: 'workflow',
...
router.post('/create-from-completion-pack', (req, res) => _createFromSource(req, res, {
    sourceIdField: 'completion_pack_id', sourceTable: 'commander_tax_completion_packs', linkedType: 'completion_pack',
...
router.post('/create-from-sop', (req, res) => _createFromSource(req, res, {
    sourceIdField: 'sop_id', sourceTable: 'commander_sop_templates', linkedType: 'sop',
...
router.get('/reviews/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/qms/reviews/:id', err);
...
router.put('/reviews/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/qms/reviews/:id', err);
...
router.delete('/reviews/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/qms/reviews/:id', err);
...
async function _applyReviewAction(req, res, allowedFrom, newStatus, eventType, extraPatch) {
    ...
    try {
        ...
        console.error(`PUT /api/commander/qms/reviews/:id/${eventType}`, err);
...
router.get('/reviews/:id/findings', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/qms/reviews/:id/findings', err);
...
router.post('/reviews/:id/findings', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/qms/reviews/:id/findings', err);
...
router.get('/reviews/:id/events', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/qms/reviews/:id/events', err);
...
router.put('/findings/:findingId', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/qms/findings/:findingId', err);
...
router.put('/findings/:findingId/resolve', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/qms/findings/:findingId/resolve', err);
...
router.put('/findings/:findingId/verify', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/qms/findings/:findingId/verify', err);
...
router.delete('/findings/:findingId', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/qms/findings/:findingId', err);
