/* =============================================================
   ...
   Mounted at /api/commander/compliance-packs
   ============================================================= */
'use strict';
...
async function verifyPackOwnership(cid, packId) {
    const { data } = await supabase
        .from('commander_compliance_packs')
        .select('*')
        .eq('id', packId)
        .eq('company_id', cid)
...
async function logPackEvent(cid, packId, eventType, oldStatus, newStatus, actorUserId, notes, metadata) {
    await supabase.from('commander_compliance_pack_events').insert({
        company_id:    cid,
        pack_id:       packId,
...
router.post('/', async (req, res) => {
    ...
    const [clientOk, ownerOk, reviewerOk] = await Promise.all([
        ...
        verifyBelongsToCompany(cid, 'commander_team_members', owner_team_member_id),
        verifyBelongsToCompany(cid, 'commander_team_members', reviewer_team_member_id),
    ]);
    ...
    await auditFromReq(req, 'CREATE', 'commander_compliance_pack', data.id, { module: 'commander', pack_type });
...
router.put('/:id', async (req, res) => {
    ...
    await auditFromReq(req, 'UPDATE', 'commander_compliance_pack', data.id, { module: 'commander' });
...
router.delete('/:id', async (req, res) => {
    ...
    await auditFromReq(req, 'UPDATE', 'commander_compliance_pack', parseInt(req.params.id), {
        module: 'commander', action: 'compliance_pack_cancelled',
    });
...
router.post('/:id/recalculate-readiness', async (req, res) => {
    ...
    const { data: items, error: iErr } = await supabase
        .from('commander_compliance_pack_items')
    ...
    await auditFromReq(req, 'UPDATE', 'commander_compliance_pack', data.id, {
        module: 'commander', action: 'readiness_recalculated', score, readiness_status,
    });
...
router.post('/:id/items', async (req, res) => {
    ...
    await auditFromReq(req, 'CREATE', 'commander_compliance_pack_item', data.id, {
        module: 'commander', action: 'compliance_pack_item_added', pack_id: packId,
    });
...
router.put('/:id/items/:itemId', async (req, res) => {
    ...
    await auditFromReq(req, 'UPDATE', 'commander_compliance_pack_item', data.id, {
        module: 'commander', action: 'compliance_pack_item_updated', pack_id: packId,
    });
...
router.delete('/:id/items/:itemId', async (req, res) => {
    ...
    await auditFromReq(req, 'UPDATE', 'commander_compliance_pack_item', itemId, {
        module: 'commander', action: 'compliance_pack_item_updated', pack_id: packId,
...
router.post('/:id/generate-default-items', async (req, res) => {
    ...
    await auditFromReq(req, 'CREATE', 'commander_compliance_pack_item', packId, {
        module: 'commander', action: 'compliance_pack_defaults_generated',
        pack_type: pack.pack_type, created_count: created.length,
    });
...
router.post('/:id/generate-from-documents', async (req, res) => {
    ...
    await auditFromReq(req, 'CREATE', 'commander_compliance_pack_item', packId, {
        module: 'commander', action: 'compliance_pack_documents_generated', created_count: created.length,
    });
