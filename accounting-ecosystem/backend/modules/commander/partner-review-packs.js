...
async function _verifyPack(id, cid) {
    const { data } = await supabase
        .from('commander_partner_review_packs')
        .select('*')
        .eq('id', id)
        .eq('company_id', cid)
        .maybeSingle();
...
async function _writeEvent(packId, cid, eventType, oldStatus, newStatus, userId, notes, meta) {
    await supabase.from('commander_partner_review_pack_events').insert({
        pack_id:       packId,
        company_id:    cid,
...
async function _buildReportSnapshot({ cid, reviewPeriodStart, reviewPeriodEnd, periodKey, snapshotStart, snapshotEnd, warnings }) {
    ...
    return {
        ...
        commander_score_movement: practiceScoreMovement,
        movement,
        warnings,
        assumptions: [
...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/partner-review-packs', err);
...
router.post('/generate', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/partner-review-packs/generate', err);
...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/partner-review-packs/:id', err);
...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/partner-review-packs/:id', err);
...
router.put('/:id/submit-review', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/partner-review-packs/:id/submit-review', err);
...
router.put('/:id/approve', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/partner-review-packs/:id/approve', err);
...
router.put('/:id/reject', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/partner-review-packs/:id/reject', err);
...
router.delete('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/partner-review-packs/:id', err);
...
router.get('/:id/report-data', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/partner-review-packs/:id/report-data', err);
...
router.get('/:id/report-html', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/partner-review-packs/:id/report-html', err);
...
router.get('/:id/report-pdf', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/partner-review-packs/:id/report-pdf', err);
...
router.get('/:id/events', async (req, res) => {
    ...
    try {
        ...
        const { data, error } = await supabase
            .from('commander_partner_review_pack_events')
            .select('*')
            .eq('pack_id', pack.id)
            .eq('company_id', cid)
        ...
        console.error('GET /api/commander/partner-review-packs/:id/events', err);
...
function _buildHtmlReport(pack) {
    ...
    const sm = r.commander_score_movement || {};
