/* =============================================================
   ...
   Mounted at /api/commander/reminders
   ============================================================= */
'use strict';
...
const SOURCE_TABLE = {
    deadline:          'commander_deadlines',
    task:              'commander_tasks',
    billing_pack:      'commander_billing_packs',
    health_action:     'commander_client_health_actions',
    engagement_period: 'commander_engagement_periods',
    engagement:        'commander_client_engagements',
    team_member:       'commander_team_members',
    client:            'commander_clients',
};
...
router.get('/suggestions', async (req, res) => {
    ...
    try {
        const [
            ...
            supabase.from('commander_reminders')
            ...
            supabase.from('commander_client_health_actions')
        ...
        for (const d of (deadlines.data || [])) {
            ...
            addSuggestion({
                ...
                due_date:      d.due_date,
                action_url:    '/commander/deadlines.html',
            });
        }
        ...
        for (const tk of (reviewTasks.data || [])) {
            addSuggestion({
                ...
                severity:      'normal',
                action_url:    '/commander/tasks.html',
            });
        }
        ...
        for (const bp of (billingPacks.data || [])) {
            ...
            addSuggestion({
                ...
                action_url:    '/commander/billing.html',
            });
        }
        ...
        for (const ha of (healthActions.data || [])) {
            ...
            addSuggestion({
                ...
                action_url:    '/commander/client-health.html',
            });
        }
        ...
        for (const p of (periods.data || [])) {
            addSuggestion({
                ...
                severity:      'normal',
                action_url:    '/commander/engagement-periods.html',
            });
        }
        ...
        for (const eng of (engagements.data || [])) {
            ...
            addSuggestion({
                ...
                severity:      'normal',
                action_url:    '/commander/client-detail.html?id=' + eng.client_id,
            });
        }
        ...
        for (const memberId of Object.keys(memberLoad)) {
            ...
            addSuggestion({
                ...
                action_url:    '/commander/capacity.html',
            });
        }
...
router.post('/create-from-suggestion', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'CREATE', 'commander_reminder', data.id, {
            module: 'commander', action: 'reminder_created_from_suggestion',
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'CREATE', 'commander_reminder', data.id, {
            module: 'commander', action: 'reminder_created',
            reminder_type, source_type, source_id,
        });
...
router.put('/:id/snooze', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'UPDATE', 'commander_reminder', reminderId, {
            module: 'commander', action: 'reminder_snoozed', snoozed_until,
        });
...
router.put('/:id/complete', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'UPDATE', 'commander_reminder', reminderId, {
            module: 'commander', action: 'reminder_completed',
        });
...
router.put('/:id/dismiss', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'UPDATE', 'commander_reminder', reminderId, {
            module: 'commander', action: 'reminder_dismissed',
        });
...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'UPDATE', 'commander_reminder', reminderId, {
            module: 'commander', action: 'reminder_updated', fields: Object.keys(updates),
        });
...
router.delete('/:id', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'DELETE', 'commander_reminder', reminderId, {
            module: 'commander', action: 'reminder_cancelled',
        });
