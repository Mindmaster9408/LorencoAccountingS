...
const SOURCE_TABLE = {
    quality_finding:   'commander_quality_findings',
    knowledge_article: 'commander_knowledge_articles',
    tax_dispute:       'commander_tax_dispute_cases',
    completion_pack:   'commander_tax_completion_packs',
};
...
async function _writeEvent(riskId, cid, eventType, oldStatus, newStatus, userId, notes, meta, opts) {
    await supabase.from('commander_risk_events').insert({
        risk_id:       riskId,
...
router.get('/summary', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/risk-register/summary', err);
...
router.get('/heatmap', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/risk-register/heatmap', err);
...
router.get('/risks', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/risk-register/risks', err);
...
router.post('/risks', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_created', 'commander_risk', risk.id, { category });

        return res.status(201).json(risk);
    } catch (err) {
        console.error('POST /api/commander/risk-register/risks', err);
    ...
    try {
        ...
        if (!clientId && clientIdVia === 'quality_review') {
            const { data: review } = await supabase
                .from('commander_quality_reviews')
                .select('client_id')
        ...
        await auditFromReq(req, 'risk_created', 'commander_risk', risk.id, { source_type: sourceType, source_id: sourceId });

        return res.status(201).json(risk);
    } catch (err) {
        console.error(`POST /api/commander/risk-register/create-from-${sourceType}`, err);
...
router.get('/risks/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/risk-register/risks/:id', err);
...
router.put('/risks/:id', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_updated', 'commander_risk', risk.id, { fields: Object.keys(patch) });

        return res.json(updated);
    } catch (err) {
        console.error('PUT /api/commander/risk-register/risks/:id', err);
...
router.delete('/risks/:id', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_cancelled', 'commander_risk', risk.id, { previous_status: risk.status });

        return res.json(updated);
    } catch (err) {
        console.error('DELETE /api/commander/risk-register/risks/:id', err);
...
router.put('/risks/:id/close', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_closed', 'commander_risk', risk.id, { previous_status: risk.status });

        return res.json(updated);
    } catch (err) {
        console.error('PUT /api/commander/risk-register/risks/:id/close', err);
...
router.put('/risks/:id/reopen', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_reopened', 'commander_risk', risk.id, { previous_status: risk.status });

        return res.json(updated);
    } catch (err) {
        console.error('PUT /api/commander/risk-register/risks/:id/reopen', err);
...
router.get('/risks/:id/controls', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/risk-register/risks/:id/controls', err);
...
router.post('/risks/:id/controls', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_control_added', 'commander_risk', risk.id, { control_id: control.id });

        return res.status(201).json(control);
    } catch (err) {
        console.error('POST /api/commander/risk-register/risks/:id/controls', err);
...
router.put('/controls/:controlId', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_control_updated', 'commander_risk', control.risk_id, { control_id: control.id, fields: Object.keys(patch) });

        return res.json(updated);
    } catch (err) {
        console.error('PUT /api/commander/risk-register/controls/:controlId', err);
...
router.delete('/controls/:controlId', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_control_removed', 'commander_risk', control.risk_id, { control_id: control.id });

        return res.json(updated);
    } catch (err) {
        console.error('DELETE /api/commander/risk-register/controls/:controlId', err);
...
router.get('/risks/:id/reviews', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/risk-register/risks/:id/reviews', err);
...
router.post('/risks/:id/reviews', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_review_created', 'commander_risk', risk.id, { review_id: review.id });

        return res.status(201).json(review);
    } catch (err) {
        console.error('POST /api/commander/risk-register/risks/:id/reviews', err);
...
router.put('/reviews/:reviewId/complete', async (req, res) => {
    ...
    try {
        ...
        await auditFromReq(req, 'risk_review_completed', 'commander_risk', risk.id, { review_id: review.id });

        return res.json({ review: updatedReview, risk: updatedRisk });
    } catch (err) {
        console.error('PUT /api/commander/risk-register/reviews/:reviewId/complete', err);
...
router.get('/risks/:id/events', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/risk-register/risks/:id/events', err);
