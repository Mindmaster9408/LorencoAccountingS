...
async function fetchPeriod(companyId, periodId) {
  const { data } = await supabase
    .from('commander_engagement_periods')
    .select('*')
...
// ─────────────────────────────────────────────────────────────────────────────
// GET /api/commander/engagement-periods
  ...
  let q = supabase
    ...
    .select(
      `*,
       ...
       commander_client_engagements:engagement_id(engagement_name, recurrence_type, status)`,
      { count: 'exact' }
    )
...
// ─────────────────────────────────────────────────────────────────────────────
// POST /api/commander/engagements/:id/periods/generate-preview
...
// ─────────────────────────────────────────────────────────────────────────────
// POST /api/commander/engagements/:id/periods/generate
...
router.post('/engagements/:id/periods/generate', async (req, res) => {
  ...
  await auditFromReq(req, 'CREATE', 'commander_engagement_periods_batch', eng.id, {
    module: 'commander', count: created.length
  });
...
// ─────────────────────────────────────────────────────────────────────────────
// POST /api/commander/engagement-periods/:id/generate-workflow
...
router.post('/engagement-periods/:id/generate-workflow', async (req, res) => {
  ...
  try {
    ...
    await auditFromReq(req, 'GENERATE_WORKFLOW_FROM_PERIOD', 'commander_engagement_periods', period.id, {
...
// ─────────────────────────────────────────────────────────────────────────────
// PUT /api/commander/engagement-periods/:id/skip
// ─────────────────────────────────────────────────────────────────────────────
...
router.put('/engagement-periods/:id/skip', async (req, res) => {
  ...
  await auditFromReq(req, 'SKIP', 'commander_engagement_periods', period.id, { module: 'commander' });
  res.json({ period: data });
});

// ─────────────────────────────────────────────────────────────────────────────
// PUT /api/commander/engagement-periods/:id/cancel
// ─────────────────────────────────────────────────────────────────────────────
...
router.put('/engagement-periods/:id/cancel', async (req, res) => {
  ...
  await auditFromReq(req, 'CANCEL', 'commander_engagement_periods', period.id, { module: 'commander' });
  res.json({ period: data });
});

// ─────────────────────────────────────────────────────────────────────────────
// GET /api/commander/engagement-periods/:id
