...
async function _writeEvent(snapshotId, cid, eventType, userId, notes, meta) {
    await supabase.from('commander_kpi_snapshot_events').insert({
...
router.get('/summary', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/kpi-history/summary', err);
...
router.get('/trends', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/kpi-history/trends', err);
...
router.get('/compare', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/kpi-history/compare', err);
...
router.post('/capture', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/kpi-history/capture', err);
...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/kpi-history', err);
...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/kpi-history/:id', err);
...
router.delete('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/kpi-history/:id', err);
...
router.get('/:id/events', async (req, res) => {
    ...
    try {
        ...
        const { data, error } = await supabase
            .from('commander_kpi_snapshot_events')
            .select('*')
        ...
        console.error('GET /api/commander/kpi-history/:id/events', err);
