...
const LINKED_TYPE_TABLE = {
    ...
    taxpayer_profile:      'commander_taxpayer_profiles',
    individual_tax_return: 'commander_individual_tax_returns',
    company_tax_return:    'commander_company_tax_returns',
    provisional_tax_plan:  'commander_provisional_tax_plans',
    tax_submission:        'commander_tax_submissions',
    sars_statement_line:   'commander_sars_statement_lines',
    tax_dispute:           'commander_tax_dispute_cases',
    tax_completion_pack:   'commander_tax_completion_packs',
    workflow_run:          'commander_workflow_runs',
    task:                  'commander_tasks',
    document_request:      'commander_document_requests',
    compliance_pack:       'commander_compliance_packs',
};
...
async function _verifyArticle(id, cid) {
    const { data } = await supabase
        .from('commander_knowledge_articles')
        .select('*')
        .eq('id', id)
        .eq('company_id', cid)
        .maybeSingle();
...
async function _verifyLink(linkId, articleId, cid) {
    const { data } = await supabase
        .from('commander_knowledge_links')
        .select('*')
        .eq('id', linkId)
...
async function _writeEvent(articleId, cid, eventType, oldStatus, newStatus, userId, notes, meta) {
    await supabase.from('commander_knowledge_events').insert({
...
router.get('/summary', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/knowledge/summary', err);
...
router.get('/linked/:linkedType/:linkedId', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/knowledge/linked/:linkedType/:linkedId', err);
...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/knowledge', err);
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/knowledge', err);
...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/knowledge/:id', err);
...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/knowledge/:id', err);
...
router.delete('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/knowledge/:id', err);
...
router.put('/:id/submit-review', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/knowledge/:id/submit-review', err);
...
router.put('/:id/approve', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/knowledge/:id/approve', err);
...
router.put('/:id/archive', async (req, res) => {
    ...
    try {
        ...
        console.error('PUT /api/commander/knowledge/:id/archive', err);
        return res.status(500).json({ error: 'Failed to archive knowledge article.' });
    }
});
...
router.get('/:id/links', async (req, res) => {
    ...
    try {
        ...
        console.error('GET /api/commander/knowledge/:id/links', err);
...
router.post('/:id/links', async (req, res) => {
    ...
    try {
        ...
        console.error('POST /api/commander/knowledge/:id/links', err);
...
router.delete('/:id/links/:linkId', async (req, res) => {
    ...
    try {
        ...
        console.error('DELETE /api/commander/knowledge/:id/links/:linkId', err);
...
router.get('/:id/events', async (req, res) => {
    ...
    try {
        ...
        const { data, error } = await supabase
            .from('commander_knowledge_events')
            .select('*')
            .eq('article_id', article.id)
            .eq('company_id', cid)
            .order('created_at', { ascending: false });
        ...
        console.error('GET /api/commander/knowledge/:id/events', err);
