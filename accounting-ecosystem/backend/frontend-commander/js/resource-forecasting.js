...
(function () {
    ...
    var BASE = '/api/commander/resource-forecasting';
    var _teamList = [];
    ...
    function _loadSummary() {
        window.CommanderAPI.fetch(BASE + '/summary' + _qs())
    ...
    function _loadWeekBoard() {
        window.CommanderAPI.fetch(BASE + '/forecast' + _qs())
            .then(function (r) { if (_deniedCheck(r.status)) throw new Error('denied'); return r.json(); })
            .then(function (d) {
                var weekly = d.weekly || [];
    ...
    function _loadTeam() {
        window.CommanderAPI.fetch(BASE + '/team' + _qsNoMember())
            .then(function (r) { if (_deniedCheck(r.status)) throw new Error('denied'); return r.json(); })
            .then(function (d) {
                _teamList = d.team || [];
    ...
    function _loadClients() {
        window.CommanderAPI.fetch(BASE + '/clients' + _qsNoMember())
            .then(function (r) { if (_deniedCheck(r.status)) throw new Error('denied'); return r.json(); })
            .then(function (d) {
    ...
    function _loadDeadlines() {
        window.CommanderAPI.fetch(BASE + '/deadlines' + _qsNoMember())
            .then(function (r) { if (_deniedCheck(r.status)) throw new Error('denied'); return r.json(); })
            .then(function (d) {
    ...
    function _loadSnapshots() {
        window.CommanderAPI.fetch(BASE + '/snapshots')
            .then(function (r) { if (_deniedCheck(r.status)) throw new Error('denied'); return r.json(); })
            .then(function (d) {
    ...
    function rfArchiveSnapshot(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/snapshots/' + id, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
