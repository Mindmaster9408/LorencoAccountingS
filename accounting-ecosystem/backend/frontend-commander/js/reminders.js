...
(function () {
    ...
    var BASE = '/api/commander/reminders';
    ...
    function loadList() {
        ...
        return CommanderAPI.fetch(BASE + '?limit=500')
            .then(function (d) {
    ...
    function loadSuggestions() {
        ...
        CommanderAPI.fetch(BASE + '/suggestions')
            .then(function (d) {
    ...
    function createFromSuggestion(idx) {
        ...
        CommanderAPI.fetch(BASE + '/create-from-suggestion', {
            method: 'POST',
    ...
    function submitSnooze() {
        ...
        CommanderAPI.fetch(BASE + '/' + _snoozingId + '/snooze', {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
    ...
    function completeReminder(id) {
        CommanderAPI.fetch(BASE + '/' + id + '/complete', { method: 'PUT' })
    ...
    function dismissReminder(id) {
        ...
        CommanderAPI.fetch(BASE + '/' + id + '/dismiss', { method: 'PUT' })
            .then(function () { Promise.all([loadSummary(), loadList()]); })
