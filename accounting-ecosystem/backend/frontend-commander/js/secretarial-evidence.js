...
(function () {
    ...
    var BASE = '/api/commander/secretarial-evidence';
    ...
    function seLoadTemplates() {
        window.CommanderAPI.fetch(BASE + '/templates')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function seSubmitTemplate() {
        ...
        window.CommanderAPI.fetch(BASE + '/templates', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function seArchiveTemplate(id) {
        window.CommanderAPI.fetch(BASE + '/templates/' + id, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
    ...
    function seLoadChecklists() {
        window.CommanderAPI.fetch(BASE + '/checklists')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function seSubmitGenerateChecklist() {
        ...
        window.CommanderAPI.fetch(BASE + '/checklists/generate', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function seOpenChecklistDetail(id) {
        ...
        Promise.all([
            window.CommanderAPI.fetch(BASE + '/checklists/' + id).then(function (r) { return r.json(); }),
            window.CommanderAPI.fetch(BASE + '/checklists/' + id + '/items').then(function (r) { return r.json(); }),
    ...
    function seRegenerateChecklist(id) {
        window.CommanderAPI.fetch(BASE + '/checklists/' + id + '/regenerate', { method: 'POST' })
            .then(function (r) { return r.json(); })
    ...
    function seSubmitLinkDoc() {
        ...
        var promise = existingId
            ? window.CommanderAPI.fetch(BASE + '/items/' + _currentItemId + '/link-document-request', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ document_request_id: parseInt(existingId) }) })
            : window.CommanderAPI.fetch(BASE + '/items/' + _currentItemId + '/create-document-request', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ document_category: document.getElementById('ldCategory').value || null }) });
    ...
    function seSubmitVerify() {
        window.CommanderAPI.fetch(BASE + '/items/' + _currentItemId + '/verify', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ verification_notes: document.getElementById('vfNotes').value || null }) })
            .then(function (r) { return r.json(); })
    ...
    function seSubmitWaive() {
        ...
        window.CommanderAPI.fetch(BASE + '/items/' + _currentItemId + '/waive', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ reason: reason }) })
            .then(function (r) { return r.json(); })
