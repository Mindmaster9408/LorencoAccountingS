...
(function () {
    ...
    async function loadProfile() {
        try {
            var res = await CommanderAPI.fetch('/api/commander/profile');
    ...
    function populateForm(p) {
        ...
        setVal('pPracticeType',          p.commander_type);
        setVal('pEmail',                 p.commander_email);
        setVal('pPhone',                 p.commander_phone);
        setVal('pWebsite',               p.commander_website);
    ...
    async function saveProfile(e) {
        ...
        var body = {
            ...
            commander_type:           document.getElementById('pPracticeType').value || null,
            commander_email:          getStr('pEmail'),
            commander_phone:          getStr('pPhone'),
            commander_website:        getStr('pWebsite'),
        ...
        try {
            ...
            CommanderAPI.showToast('Profile saved!');
        } catch(err) {
