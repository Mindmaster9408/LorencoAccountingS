...
(function () {
    ...
    var BASE = '/api/commander/alert-rules';
    var _rules = [];
    var _groups = [];
    var _activeGroup = '';
    ...
    function _loadGroups() {
        window.CommanderAPI.fetch(BASE + '/groups')
            .then(function (r) { return r.json(); })
            .then(function (d) {
                _groups = d.groups || [];
                _renderGroupBar();
    ...
    function arResetGroup(groupId, groupName) {
        ...
        window.CommanderAPI.fetch(BASE + '/groups/' + groupId + '/reset', { method: 'POST' })
            .then(function (r) { return r.json(); })
            .then(function () {
    ...
    function arToggleEnabled() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentRule.id, {
            method: 'PUT',
    ...
    function arResetRule(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/' + id + '/reset', { method: 'POST' })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function arDeleteRule(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/' + id, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function arValidateRuleForm() {
        window.CommanderAPI.fetch(BASE + '/validate', {
    ...
    function arExport() {
        window.CommanderAPI.fetch(BASE + '/export')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function arSubmitImport() {
        ...
        window.CommanderAPI.fetch(BASE + '/import', {
