...
(function () {
    ...
    var BASE = '/api/commander/kpi-history';
    var _page = 1;
    ...
    function kpiCreatePartnerPackFromSelected() {
        ...
        window.location.href = '/commander/partner-review-packs.html?generate=1&snapshot_start_id=' + ids[0] + '&snapshot_end_id=' + ids[1];
    }
    ...
    function kpiSubmitCapture(force) {
        ...
        window.CommanderAPI.fetch(BASE + '/capture', {
    ...
    function kpiLoadTrend() {
        ...
        window.CommanderAPI.fetch(BASE + '/trends?' + p.join('&'))
            .then(function (r) { return r.json(); })
    ...
    function _loadCompare(idA, idB) {
        ...
        window.CommanderAPI.fetch(BASE + '/compare?snapshot_a_id=' + idA + '&snapshot_b_id=' + idB)
            .then(function (r) { return r.json(); })
