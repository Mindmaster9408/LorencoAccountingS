...
(function () {
    ...
    var BASE = '/api/commander/learning-centre';
    var TEAM_BASE = '/api/commander/team';
    var SKILLS_BASE = '/api/commander/skills-matrix/skills';
    var _tab = 'plans';
    var _teamList = [];
    var _skillsList = [];
    ...
    function _loadSkillsList() {
        window.CommanderAPI.fetch(SKILLS_BASE)
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function lcLoadPlans() {
        ...
        window.CommanderAPI.fetch(BASE + '/plans' + (status ? '?status=' + status : ''))
            .then(function (r) { return r.json(); })
            .then(function (d) {
                var plans = d.plans || [];
    ...
    function lcLoadSuggestions() {
        ...
        window.CommanderAPI.fetch(BASE + '/suggested-goals/' + memberId)
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function lcOpenPlanDetail(id) {
        _currentPlanId = id;
        window.CommanderAPI.fetch(BASE + '/plans/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                _currentPlan = d;
    ...
    function _renderGoalCard(g, acts) {
        var skillLabel = g.commander_skills ? g.commander_skills.display_name : null;
    ...
    function lcCompleteGoal(goalId) {
        window.CommanderAPI.fetch(BASE + '/goals/' + goalId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ status: 'completed' }) })
            .then(function (r) { return r.json(); })
    ...
    function lcCancelPlan() {
        ...
        window.CommanderAPI.fetch(BASE + '/plans/' + _currentPlanId, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
    ...
    function lcCaptureSnapshot() {
        window.CommanderAPI.fetch(BASE + '/progress/' + _currentPlanId + '/snapshot', { method: 'POST' })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function lcSubmitGoal() {
        ...
        window.CommanderAPI.fetch(BASE + '/goals', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function lcSubmitActivity() {
        ...
        window.CommanderAPI.fetch(BASE + '/activities', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function lcLoadCpd() {
        window.CommanderAPI.fetch(BASE + '/cpd')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function lcSubmitCpd() {
        ...
        window.CommanderAPI.fetch(BASE + '/cpd', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function lcArchiveCpd(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/cpd/' + id, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
