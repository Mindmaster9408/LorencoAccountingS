...
(function () {
    ...
    var BASE = '/api/commander/executive-reporting';
    var TEAM_BASE = '/api/commander/team';
    var _tab = 'reports';
    ...
    function _loadTeamMembers() {
        window.CommanderAPI.fetch(TEAM_BASE)
    ...
    function erLoadReports() {
        ...
        window.CommanderAPI.fetch(BASE + '/?' + params.toString())
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function erSubmitCreateReport(generateNow) {
        ...
        window.CommanderAPI.fetch(url, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function erOpenReportDetail(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function _renderReportOverview() {
        ...
        document.getElementById('reportOverviewBody').innerHTML =
            ...
            '<div class="section-heading">Practice Health Summary</div><textarea id="roHealthSummary" ' + (editable ? '' : 'disabled') + '>' + _html(r.commander_health_summary) + '</textarea>' +
    ...
    function erSaveNarrative() {
        var payload = {
            ...
            commander_health_summary: document.getElementById('roHealthSummary').value || null,
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentReportId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function erGenerateReport() {
        window.CommanderAPI.fetch(BASE + '/' + _currentReportId + '/generate', { method: 'POST' })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function erReportAction(action) {
        window.CommanderAPI.fetch(BASE + '/' + _currentReportId + '/' + action, { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function _loadReportSections() {
        window.CommanderAPI.fetch(BASE + '/' + _currentReportId + '/sections')
            .then(function (r) { return r.json(); })
    ...
    function erSetSectionStatus(sectionId, status) {
        window.CommanderAPI.fetch(BASE + '/' + _currentReportId + '/sections/' + sectionId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ section_status: status }) })
            .then(function (r) { return r.json(); })
    ...
    function _loadReportDecisions() {
        window.CommanderAPI.fetch(BASE + '/decisions?report_id=' + _currentReportId)
            .then(function (r) { return r.json(); })
    ...
    function erSubmitCreateDecision() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentReportId + '/decisions', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function erCompleteDecision(id) {
        window.CommanderAPI.fetch(BASE + '/decisions/' + id + '/complete', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function _loadReportActions() {
        window.CommanderAPI.fetch(BASE + '/actions?report_id=' + _currentReportId)
            .then(function (r) { return r.json(); })
    ...
    function erSubmitCreateAction() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentReportId + '/actions', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function erCompleteAction(id) {
        window.CommanderAPI.fetch(BASE + '/actions/' + id + '/complete', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function _loadReportEvents() {
        window.CommanderAPI.fetch(BASE + '/' + _currentReportId + '/events')
            .then(function (r) { return r.json(); })
    ...
    function erLoadDecisions() {
        ...
        window.CommanderAPI.fetch(BASE + '/decisions?' + params.toString())
            .then(function (r) { return r.json(); })
    ...
    function erLoadActions() {
        ...
        window.CommanderAPI.fetch(BASE + '/actions?' + params.toString())
            .then(function (r) { return r.json(); })
    ...
    function erLoadEvents() {
        window.CommanderAPI.fetch(BASE + '/events')
            .then(function (r) { return r.json(); })
    ...
    function erSubmitReason() {
        ...
        window.CommanderAPI.fetch(url, { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ reason: reason }) })
            .then(function (r) { return r.json(); })
