...
(function () {
    ...
    var BASE = '/api/commander/secretarial-governance';
    ...
    function _loadClientOptions() {
        return window.CommanderAPI.fetch(CLIENTS_BASE)
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function sgLoadResolutions() {
        ...
        window.CommanderAPI.fetch(BASE + '/resolutions' + (status ? '?resolution_status=' + encodeURIComponent(status) : ''))
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function sgSubmitCreateResolution() {
        ...
        window.CommanderAPI.fetch(BASE + '/resolutions', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function sgOpenResolutionDetail(id) {
        window.CommanderAPI.fetch(BASE + '/resolutions/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function sgCancelResolution(id) {
        window.CommanderAPI.fetch(BASE + '/resolutions/' + id, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
    ...
    function sgArchiveResolution(id) {
        window.CommanderAPI.fetch(BASE + '/resolutions/' + id, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ resolution_status: 'archived' }) })
            .then(function (r) { return r.json(); })
    ...
    function _resolutionAction(id, action, successMsg) {
        window.CommanderAPI.fetch(BASE + '/resolutions/' + id + '/' + action, { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function sgLoadMeetings() {
        ...
        window.CommanderAPI.fetch(BASE + '/meetings' + (status ? '?meeting_status=' + encodeURIComponent(status) : ''))
            .then(function (r) { return r.json(); })
            .then(function (d) {
                var rows = d.meetings || [];
    ...
    function sgSubmitCreateMeeting() {
        ...
        window.CommanderAPI.fetch(BASE + '/meetings', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function sgOpenMeetingDetail(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/meetings/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function sgCompleteMeeting(id) {
        window.CommanderAPI.fetch(BASE + '/meetings/' + id, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ meeting_status: 'completed' }) })
            .then(function (r) { return r.json(); })
    ...
    function sgCancelMeeting(id) {
        window.CommanderAPI.fetch(BASE + '/meetings/' + id, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
    ...
    function _meetingAction(id, action, successMsg) {
        window.CommanderAPI.fetch(BASE + '/meetings/' + id + '/' + action, { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function sgSubmitAttendee() {
        ...
        window.CommanderAPI.fetch(BASE + '/meetings/' + _currentMeetingId + '/attendees', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function sgLoadDecisions() {
        ...
        window.CommanderAPI.fetch(BASE + '/decisions' + (status ? '?decision_status=' + encodeURIComponent(status) : ''))
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function sgSubmitCreateDecision() {
        ...
        window.CommanderAPI.fetch(BASE + '/decisions', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function sgOpenDecisionDetail(id) {
        window.CommanderAPI.fetch(BASE + '/decisions/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function sgCancelDecision(id) {
        window.CommanderAPI.fetch(BASE + '/decisions/' + id, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
    ...
    function _decisionAction(id, action, successMsg) {
        window.CommanderAPI.fetch(BASE + '/decisions/' + id + '/' + action, { method: 'PUT' })
            .then(function (r) { return r.json(); })
