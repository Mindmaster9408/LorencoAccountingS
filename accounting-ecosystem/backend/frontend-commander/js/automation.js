...
(function () {
    ...
    var BASE = '/api/commander/automation';
    var _tab = 'rules';
    ...
    function _loadCatalogue() {
        window.CommanderAPI.fetch(BASE + '/catalogue')
            .then(function (r) { return r.json(); })
            .then(function (d) {
                _catalogue = d;
    ...
    function autoLoadRules() {
        ...
        window.CommanderAPI.fetch(BASE + '/rules?' + params.toString())
            .then(function (r) { return r.json(); })
    ...
    function autoSubmitCreateRule() {
        ...
        window.CommanderAPI.fetch(BASE + '/rules', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
    ...
    function autoOpenRuleDetail(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/rules/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function autoApproveRule() {
        ...
        window.CommanderAPI.fetch(BASE + '/rules/' + _currentRuleId + '/approve', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ approval_notes: notes || null }) })
            .then(function (r) { return r.json(); })
    ...
    function autoRuleAction(action) {
        window.CommanderAPI.fetch(BASE + '/rules/' + _currentRuleId + '/' + action, { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function _loadRuleEvents(id) {
        window.CommanderAPI.fetch(BASE + '/rules/' + id + '/events')
            .then(function (r) { return r.json(); })
    ...
    function autoLoadRuns() {
        ...
        window.CommanderAPI.fetch(BASE + '/runs?' + params.toString())
            .then(function (r) { return r.json(); })
    ...
    function autoOpenRunDetail(id) {
        Promise.all([
            window.CommanderAPI.fetch(BASE + '/runs/' + id).then(function (r) { return r.json(); }),
            window.CommanderAPI.fetch(BASE + '/runs/' + id + '/steps').then(function (r) { return r.json(); }),
    ...
    function autoSubmitReason() {
        ...
        window.CommanderAPI.fetch(BASE + '/rules/' + _currentRuleId, { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ reason: reason }) })
            .then(function (r) { return r.json(); })
