/* ============================================================
   ...
   Fix: all CommanderAPI.fetch() calls now chain .then(res=>res.json()).
   ============================================================ */
(function () {
    'use strict';

    var esc = CommanderAPI.escHtml;
    var BASE = '/api/commander/tax-reports';
    ...
    function _loadProgress() {
        ...
        CommanderAPI.fetch(BASE + '/progress' + _qs())
            .then(function (res) { return res.json(); })
            .then(function (d) {
    ...
    function _loadStatusBreakdown() {
        ...
        CommanderAPI.fetch(BASE + '/status-breakdown' + _qs())
            .then(function (res) { return res.json(); })
            .then(function (d) {
                if (!grid) return;
                var sections = [
    ...
    function _loadDocOutstanding() {
        ...
        CommanderAPI.fetch(BASE + '/document-outstanding' + _qs())
            .then(function (res) { return res.json(); })
            .then(function (d) {
    ...
    function _loadReviewBottlenecks() {
        ...
        CommanderAPI.fetch(BASE + '/review-bottlenecks' + _qs())
            .then(function (res) { return res.json(); })
            .then(function (d) {
    ...
    function _loadPartnerSummary() {
        ...
        CommanderAPI.fetch(BASE + '/partner-summary' + _qs())
            .then(function (res) { return res.json(); })
            .then(function (d) {
                if (!tbody) return;
                var rows = d.summary || [];
    ...
    function _loadRiskSummary() {
        ...
        CommanderAPI.fetch(BASE + '/risk-summary' + _qs())
            .then(function (res) { return res.json(); })
            .then(function (d) {
                if (grid) {
                    grid.innerHTML =
    ...
    function _loadBulkSummary() {
        ...
        CommanderAPI.fetch(BASE + '/bulk-operation-summary')
            .then(function (res) { return res.json(); })
            .then(function (d) {
                if (!tbody) return;
    ...
    function trrOpenHtml(report, btnId) {
        ...
        CommanderAPI.fetch(BASE + '/' + report + '/report-html' + _qs())
            .then(function (res) {
            ...
            .catch(function (e) { CommanderAPI.showToast('Failed to open HTML report: ' + (e.message || ''), true); })
    ...
    function trrDownloadPdf(report, filename, btnId) {
        ...
        if (_exporting[key]) return;
        _setExportState(key, true, btnId);
        CommanderAPI.fetch(BASE + '/' + report + '/report-pdf' + _qs())
            .then(function (res) {
                if (!res.ok) throw new Error('Server error ' + res.status);
                return res.blob();
            })
            .then(function (blob) {
                ...
                CommanderAPI.showToast('PDF downloaded.', false);
            })
            .catch(function (e) { CommanderAPI.showToast('PDF download failed: ' + (e.message || ''), true); })
            .finally(function () { _setExportState(key, false, btnId); });
    }
