...
(function () {
    ...
    var BASE = '/api/commander/beneficial-ownership';
    ...
    function boSubmitOwner() {
        ...
        window.CommanderAPI.fetch(BASE + '/owners', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function boOpenOwnerDetail(id) {
        window.CommanderAPI.fetch(BASE + '/owners/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function boVerifyOwner(id) {
        window.CommanderAPI.fetch(BASE + '/owners/' + id + '/verify', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function boArchiveOwner(id) {
        window.CommanderAPI.fetch(BASE + '/owners/' + id + '/archive', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function boSubmitChain() {
        ...
        window.CommanderAPI.fetch(BASE + '/chains', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function boOpenChainDetail(id) {
        window.CommanderAPI.fetch(BASE + '/chains/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function boVerifyChain(id) {
        window.CommanderAPI.fetch(BASE + '/chains/' + id + '/verify', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function boArchiveChain(id) {
        window.CommanderAPI.fetch(BASE + '/chains/' + id + '/archive', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function boGenerateReadiness() {
        window.CommanderAPI.fetch(BASE + '/client/' + _currentClientId + '/generate-readiness', { method: 'POST' })
            .then(function (r) { return r.json(); })
    ...
    function boUpdateReadinessStatus(itemId, status) {
        window.CommanderAPI.fetch(BASE + '/readiness/' + itemId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ status: status }) })
            .then(function (r) { return r.json(); })
    ...
    function boRecalculateReadiness() {
        window.CommanderAPI.fetch(BASE + '/client/' + _currentClientId + '/recalculate-readiness', { method: 'POST' })
            .then(function (r) { return r.json(); })
