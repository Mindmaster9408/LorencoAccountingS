...
(function () {
    ...
    var BASE = '/api/commander/secretarial-workflows';
    ...
    function swSubmitCreate() {
        ...
        window.CommanderAPI.fetch(BASE + '/', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function swCreateGovernance(kind, changeCaseId, clientId) {
        window.location.href = '/commander/secretarial-governance.html?create=' + kind + '&client_id=' + clientId + '&change_case_id=' + changeCaseId;
    }
    ...
    function _loadGovernanceLinks(caseId) {
        ...
        Promise.all([
            window.CommanderAPI.fetch(GOV_BASE + '/resolutions?change_case_id=' + caseId).then(function (r) { return r.json(); }).catch(function () { return { resolutions: [] }; }),
            window.CommanderAPI.fetch(GOV_BASE + '/meetings?change_case_id=' + caseId).then(function (r) { return r.json(); }).catch(function () { return { meetings: [] }; }),
            window.CommanderAPI.fetch(GOV_BASE + '/decisions?change_case_id=' + caseId).then(function (r) { return r.json(); }).catch(function () { return { decisions: [] }; }),
    ...
    function _loadChecklist(caseId) {
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/checklist')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function swGenerateChecklist(caseId) {
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/generate-checklist', { method: 'POST' })
            .then(function (r) { return r.json(); })
    ...
    function swToggleChecklistItem(caseId, itemId, completed) {
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/checklist/' + itemId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ completed: completed }) })
            .then(function (r) { return r.json(); })
    ...
    function swSubmitReview(caseId) {
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/submit-review', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function swSubmitApprove() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/approve', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ override_reason: reason }) })
    ...
    function swSubmitReject() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/reject', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ rejection_reason: reason }) })
            .then(function (r) { return r.json(); })
    ...
    function swSubmitImplement() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/implement', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json().then(function (d) { return { status: r.status, body: d }; }); })
            .then(function (res) {
                if (res.body.error) {
    ...
    function swSubmitComplete() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/complete', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ completion_reason: reason }) })
            .then(function (r) { return r.json(); })
    ...
    function swCancelCase(caseId) {
        window.CommanderAPI.fetch(BASE + '/' + caseId, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
    ...
    function _loadEvents(caseId) {
        window.CommanderAPI.fetch(BASE + '/' + caseId + '/events')
            .then(function (r) { return r.json(); })
            .then(function (d) {
                var rows = d.events || [];
