...
(function () {
    ...
    var BASE = '/api/commander/secretarial-calendar';
    ...
    function scLoadCalendar() {
        window.CommanderAPI.fetch(BASE + '/calendar')
            .then(function (r) { return r.json(); })
            .then(function (d) {
                _calendarData = d;
    ...
    function scMarkComplete(scheduleId) {
        window.CommanderAPI.fetch(BASE + '/schedule/' + scheduleId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ status: 'completed' }) })
            .then(function (r) { return r.json(); })
    ...
    function scLoadObligations() {
        window.CommanderAPI.fetch(BASE + '/obligations')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function scSubmitObligation() {
        ...
        window.CommanderAPI.fetch(BASE + '/obligations', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
            .then(function (r) { return r.json(); })
    ...
    function scGenerateSchedule(obligationId) {
        window.CommanderAPI.fetch(BASE + '/obligations/' + obligationId + '/generate-schedule', { method: 'POST' })
            .then(function (r) { return r.json(); })
    ...
    function scOpenObligationDetail(id) {
        window.CommanderAPI.fetch(BASE + '/obligations/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
