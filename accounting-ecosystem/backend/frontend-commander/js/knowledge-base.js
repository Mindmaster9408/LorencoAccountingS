...
(function () {
    ...
    var BASE        = '/api/commander/knowledge';
    var _currentId   = null;
    ...
    function _renderLinkedBanner(linkedType, linkedId) {
        ...
        window.CommanderAPI.fetch(BASE + '/linked/' + encodeURIComponent(linkedType) + '/' + encodeURIComponent(linkedId))
    ...
    function kbSubmitCreate() {
        ...
        _submitting = true;
        window.CommanderAPI.fetch(BASE, {
            method: 'POST',
    ...
    function _loadLinksTab(body) {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentId + '/links')
            .then(function (r) { return r.json(); })
    ...
    function kbDeleteLink(linkId) {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentId + '/links/' + linkId, {
    ...
    function _loadEventsTab(body) {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentId + '/events')
            .then(function (r) { return r.json(); })
    ...
    function _renderFooter() {
        ...
        html += '<a href="/commander/risk-register.html?source_type=knowledge_article&source_id=' + encodeURIComponent(a.id) + '" ' +
    ...
    function kbSubmitReview() {
        window.CommanderAPI.fetch(BASE + '/' + _currentId + '/submit-review', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function kbApprove() {
        window.CommanderAPI.fetch(BASE + '/' + _currentId + '/approve', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function kbArchive() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentId + '/archive', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function kbSubmitEdit() {
        ...
        _submitting = true;
        window.CommanderAPI.fetch(BASE + '/' + _currentId, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(payload),
        })
