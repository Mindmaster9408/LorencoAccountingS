...
(function () {
    ...
    var BASE = '/api/commander/client-onboarding';
    ...
    var STATUS_LABELS = {
        ...
        secretarial_setup: 'Secretarial Setup', tax_setup: 'Tax Setup', commander_setup: 'Practice Setup',
    ...
    function cbLoadClientData() {
        ...
        window.CommanderAPI.fetch(BASE + '/profiles/' + _currentClientId)
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function cbStartOnboarding() {
        ...
        window.CommanderAPI.fetch(BASE + '/profiles', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ client_id: _currentClientId, entity_type: entityType }) })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function _loadEngagementReadiness() {
        ...
        if (!el) return;
        if (link) link.href = '/commander/engagement-management.html?client_id=' + _currentClientId;
        window.CommanderAPI.fetch('/api/commander/engagement-management/client/' + _currentClientId + '/profile')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function cbCheckOnboardingCoverage() {
        ...
        if (!_currentClientId) return;
        window.CommanderAPI.fetch('/api/commander/work-authorization/check', {
    ...
    function cbSaveProfile() {
        ...
        window.CommanderAPI.fetch(BASE + '/profiles/' + _currentClientId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function cbSubmitReview() {
        window.CommanderAPI.fetch(BASE + '/profiles/' + _currentClientId + '/submit-review', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function cbApprove() {
        window.CommanderAPI.fetch(BASE + '/profiles/' + _currentClientId + '/approve', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function cbComplete() {
        window.CommanderAPI.fetch(BASE + '/profiles/' + _currentClientId + '/complete', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function cbSubmitCancel() {
        ...
        window.CommanderAPI.fetch(BASE + '/profiles/' + _currentClientId + '/cancel', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ reason: reason }) })
            .then(function (r) { return r.json(); })
    ...
    function cbUpdateStep(id, status) {
        window.CommanderAPI.fetch(BASE + '/steps/' + id, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ status: status }) })
            .then(function (r) { return r.json(); })
    ...
    function cbToggleChecklistItem(id, completed) {
        window.CommanderAPI.fetch(BASE + '/checklist/' + id, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ completed: completed }) })
            .then(function (r) { return r.json(); })
    ...
    function cbRegenerateChecklist() {
        window.CommanderAPI.fetch(BASE + '/profiles/' + _currentClientId + '/checklist/generate', { method: 'POST' })
            .then(function (r) { return r.json(); })
