...
(function () {
    ...
    function _renderLinkedBanner(linkedType, linkedId) {
        ...
        window.CommanderAPI.fetch(BASE + '/reviews?linked_type=' + encodeURIComponent(linkedType) + '&linked_id=' + encodeURIComponent(linkedId))
    ...
    function _qmsCreateFromLinked(linkedType, linkedId) {
        ...
        var body = {};
        body[field] = linkedId;
        window.CommanderAPI.fetch(BASE + '/' + endpoint, {
    ...
    function _loadList() {
        ...
        window.CommanderAPI.fetch(BASE + '/reviews' + _qs())
            .then(function (r) { return r.json(); })
    ...
    function qmsSubmitCreate() {
        ...
        _submitting = true;
        window.CommanderAPI.fetch(BASE + '/reviews', {
            method: 'POST',
    ...
    function qmsOpenDetail(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/reviews/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                _currentReview = d;
                _renderTabBar();
    ...
    function _loadFindingsTab(body) {
        ...
        window.CommanderAPI.fetch(BASE + '/reviews/' + _currentId + '/findings')
            .then(function (r) { return r.json(); })
    ...
    function _renderFindingsTab(items, body) {
        ...
        if (!items.length) {
            ...
            items.forEach(function (f) {
                ...
                html += '<a class="btn-action btn-sm" href="/commander/risk-register.html?source_type=quality_finding&source_id=' + f.id + '" ' +
    ...
    function qmsResolveFinding(findingId) {
        window.CommanderAPI.fetch(BASE + '/findings/' + findingId + '/resolve', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function qmsVerifyFinding(findingId) {
        window.CommanderAPI.fetch(BASE + '/findings/' + findingId + '/verify', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function qmsCancelFinding(findingId) {
        ...
        window.CommanderAPI.fetch(BASE + '/findings/' + findingId, { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function _loadEventsTab(body) {
        ...
        window.CommanderAPI.fetch(BASE + '/reviews/' + _currentId + '/events')
            .then(function (r) { return r.json(); })
    ...
    function _renderFooter() {
        ...
        if (r.linked_type && r.linked_id) {
            html += '<a href="/commander/quality-management.html?linked_type=' + encodeURIComponent(r.linked_type) + '&linked_id=' + encodeURIComponent(r.linked_id) + '" ' +
    ...
    function qmsStart() {
        window.CommanderAPI.fetch(BASE + '/reviews/' + _currentId + '/start', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function qmsCancelReview() {
        ...
        window.CommanderAPI.fetch(BASE + '/reviews/' + _currentId, { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function qmsSubmitAction() {
        ...
        _submitting = true;
        window.CommanderAPI.fetch(BASE + '/reviews/' + _currentId + '/' + _actionType, {
