(function () {
    ...
    var BASE = '/api/commander/tax-pipeline';
    ...
    function tplOpenDetail(sourceType, sourceId) {
        ...
        CommanderAPI.fetch(BASE + '/' + encodeURIComponent(sourceType) + '/' + sourceId)
            .then(function (res) { return res.json(); })
            .then(function (d) {
    ...
    function _renderDetail(d) {
        ...
        if (d.filing_stage === 'submitted') {
            ...
            var regUrl = '/commander/tax-submissions.html'
        ...
        if (d.filing_stage === 'completed') {
            ...
            var payUrl = '/commander/tax-payments.html'
