...
(function () {
    ...
    var BASE = '/api/commander/strategic-planning';
    ...
    function spLoadPlans() {
        window.CommanderAPI.fetch(BASE + '/plans')
            .then(function (r) { return r.json(); })
    ...
    function spSubmitCreatePlan() {
        ...
        window.CommanderAPI.fetch(BASE + '/plans', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function spOpenPlanDetail(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/plans/' + id + '/health')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function spPlanAction(action) {
        window.CommanderAPI.fetch(BASE + '/plans/' + _currentPlanId + '/' + action, { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function spSubmitCreateObjective() {
        ...
        window.CommanderAPI.fetch(BASE + '/plans/' + _currentPlanId + '/objectives', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function spOpenObjectiveDetail(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/objectives/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function spUpdateObjectiveStatus(status) {
        window.CommanderAPI.fetch(BASE + '/objectives/' + _currentObjectiveId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ objective_status: status }) })
            .then(function (r) { return r.json(); })
    ...
    function spSubmitCreateInitiative() {
        ...
        window.CommanderAPI.fetch(BASE + '/objectives/' + _currentObjectiveId + '/initiatives', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function spUpdateInitiativeStatus(id, status) {
        window.CommanderAPI.fetch(BASE + '/initiatives/' + id, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ initiative_status: status }) })
            .then(function (r) { return r.json(); })
    ...
    function spSubmitCreateKpi() {
        ...
        window.CommanderAPI.fetch(BASE + '/objectives/' + _currentObjectiveId + '/kpis', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function _loadPlanReviews(planId) {
        window.CommanderAPI.fetch(BASE + '/plans/' + planId + '/reviews')
            .then(function (r) { return r.json(); })
    ...
    function spSubmitCreateReview() {
        ...
        window.CommanderAPI.fetch(BASE + '/plans/' + _currentPlanId + '/reviews', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function spCreateExecutiveReport(reviewId) {
        ...
        window.location.href = '/commander/executive-reporting.html?' + params.toString();
    }

    function spReviewAction(id, action) {
        window.CommanderAPI.fetch(BASE + '/reviews/' + id + '/' + action, { method: 'PUT' })
            .then(function (r) { return r.json(); })
        ...
        window.CommanderAPI.fetch(BASE + '/plans')
            ...
            .then(function (d) {
                ...
                return Promise.all(plans.map(function (p) {
                    return window.CommanderAPI.fetch(BASE + '/plans/' + p.id + '/reviews').then(function (r) { return r.json(); }).then(function (rd) {
    ...
    function _loadPlanEvents(planId) {
        window.CommanderAPI.fetch(BASE + '/plan/' + planId + '/events')
            .then(function (r) { return r.json(); })
            .then(function (d) {
                var rows = d.events || [];
