...
(function () {
    ...
    async function loadServices() {
        ...
        try {
            ...
            var res = await CommanderAPI.fetch('/api/commander/services' + qs);
    ...
    async function _openServiceModal(id) {
        ...
        if (id) {
            try {
                var res = await CommanderAPI.fetch('/api/commander/services/' + id);
                if (res.ok) {
                    var d = await res.json();
                    svc = d.service || null;
                }
    ...
    async function saveService(e) {
        ...
        try {
            var url    = _editingServiceId ? '/api/commander/services/' + _editingServiceId : '/api/commander/services';
            ...
            closeServiceModal();
            CommanderAPI.showToast(_editingServiceId ? 'Service updated!' : 'Service added!');
            loadServices();
        } catch(err) {
    ...
    async function deactivateService() {
        ...
        try {
            var res = await CommanderAPI.fetch('/api/commander/services/' + _editingServiceId, { method: 'DELETE' });
            if (!res.ok) throw new Error('Deactivate failed');
            closeServiceModal();
            CommanderAPI.showToast('Service deactivated.');
            loadServices();
        } catch(e) {
