...
(function () {
    ...
    var BASE        = '/api/commander/risk-register';
    var _currentId   = null;
    ...
    function _renderSourceBanner(sourceType, sourceId) {
        ...
        window.CommanderAPI.fetch(BASE + '/risks?source_type=' + encodeURIComponent(sourceType) + '&source_id=' + encodeURIComponent(sourceId))
    ...
    function _loadHeatmap() {
        window.CommanderAPI.fetch(BASE + '/heatmap')
            .then(function (r) { return r.json(); })
    ...
    function _riskFilterHeatCell(likelihood, impact) {
        _page = 1;
        window.CommanderAPI.fetch(BASE + '/risks?limit=200')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function _loadList() {
        ...
        window.CommanderAPI.fetch(BASE + '/risks' + _qs())
            .then(function (r) { return r.json(); })
    ...
    function riskSubmitCreate() {
        ...
        _submitting = true;
        window.CommanderAPI.fetch(BASE + '/risks', {
            method: 'POST',
    ...
    function riskOpenDetail(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/risks/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                _currentRisk = d;
                _renderTabBar();
    ...
    function _loadControlsTab(body) {
        ...
        window.CommanderAPI.fetch(BASE + '/risks/' + _currentId + '/controls')
            .then(function (r) { return r.json(); })
    ...
    function riskRemoveControl(controlId) {
        ...
        window.CommanderAPI.fetch(BASE + '/controls/' + controlId, { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function _loadReviewsTab(body) {
        ...
        window.CommanderAPI.fetch(BASE + '/risks/' + _currentId + '/reviews')
            .then(function (r) { return r.json(); })
    ...
    function riskSubmitCompleteReview() {
        ...
        _submitting = true;
        window.CommanderAPI.fetch(BASE + '/reviews/' + _reviewIdForComplete + '/complete', {
    ...
    function _loadEventsTab(body) {
        ...
        window.CommanderAPI.fetch(BASE + '/risks/' + _currentId + '/events')
            .then(function (r) { return r.json(); })
    ...
    function riskCloseRisk() {
        window.CommanderAPI.fetch(BASE + '/risks/' + _currentId + '/close', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function riskCancelRisk() {
        ...
        window.CommanderAPI.fetch(BASE + '/risks/' + _currentId, { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
    ...
    function riskReopen() {
        window.CommanderAPI.fetch(BASE + '/risks/' + _currentId + '/reopen', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
