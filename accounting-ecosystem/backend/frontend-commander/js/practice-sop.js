...
(function () {
    ...
    function _renderFooter() {
        ...
        html += '<a href="/commander/quality-management.html?linked_type=sop&linked_id=' + encodeURIComponent(s.id) + '" ' +
    ...
    function sopArchive() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentId, { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
