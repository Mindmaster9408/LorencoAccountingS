...
(function () {
    ...
    var BASE = '/api/commander/pilot-readiness';
    var _tab = 'matrix';
    ...
    function prSubmitRunReadiness() {
        ...
        window.CommanderAPI.fetch(BASE + '/run', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
    ...
    function prLoadChecklist() {
        window.CommanderAPI.fetch(BASE + '/checklist')
            .then(function (r) { return r.json(); })
    ...
    function prSeedChecklist() {
        window.CommanderAPI.fetch(BASE + '/checklist/seed-defaults', { method: 'POST' })
            .then(function (r) { return r.json(); })
    ...
    function prUpdateChecklistStatus(id, status) {
        window.CommanderAPI.fetch(BASE + '/checklist/' + id, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ check_status: status }) })
            .then(function (r) { return r.json(); })
    ...
    function prLoadIssues() {
        ...
        window.CommanderAPI.fetch(BASE + '/issues?' + params.toString())
            .then(function (r) { return r.json(); })
    ...
    function prSubmitCreateIssue() {
        ...
        window.CommanderAPI.fetch(BASE + '/issues', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function prOpenIssueDetail(id) {
        _currentIssueId = id;
        window.CommanderAPI.fetch(BASE + '/issues/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function prResolveIssue() {
        ...
        window.CommanderAPI.fetch(BASE + '/issues/' + _currentIssueId + '/resolve', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ resolution_notes: notes || null }) })
            .then(function (r) { return r.json(); })
    ...
    function prAcceptRisk() {
        ...
        window.CommanderAPI.fetch(BASE + '/issues/' + _currentIssueId + '/accept-risk', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ resolution_notes: notes }) })
            .then(function (r) { return r.json(); })
    ...
    function prLoadRuns() {
        window.CommanderAPI.fetch(BASE + '/runs')
            .then(function (r) { return r.json(); })
    ...
    function prOpenRunDetail(id) {
        _currentRunId = id;
        window.CommanderAPI.fetch(BASE + '/runs/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
                var run = d.run;
    ...
    function prRecordDecision(decision) {
        ...
        window.CommanderAPI.fetch(BASE + '/runs/' + _currentRunId + '/decision', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ decision: decision, decision_notes: notes || null }) })
            .then(function (r) { return r.json(); })
