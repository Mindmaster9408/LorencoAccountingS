...
(function () {
    ...
    function getToken() {
        ...
        return localStorage.getItem('token') || localStorage.getItem('commander_token') || null;
    }
    ...
    // CommanderAPI.fetch() intentionally returns the raw, unparsed Response —
    ...
    // silently reading undefined off a Response object. Use CommanderAPI.json()
    // for that — it's the fix for a real, shipped bug (2026-09-04): several
    // pages called CommanderAPI.fetch() and then read properties straight off
