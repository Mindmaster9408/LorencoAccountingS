...
(function () {
  ...
  function loadSummary() {
    return CommanderAPI.fetch('/api/commander/capacity/summary')
      .then(function (data) {
  ...
  function loadTeam() {
    return CommanderAPI.fetch('/api/commander/capacity/team')
      .then(function (data) {
  ...
  function loadClients() {
    return CommanderAPI.fetch('/api/commander/capacity/clients')
      .then(function (data) {
  ...
  function loadRisks() {
    CommanderAPI.fetch('/api/commander/capacity/risks')
      .then(function (d) {
  ...
  function saveCapacity() {
    ...
    CommanderAPI.fetch('/api/commander/team/' + memberId + '/capacity', {
      method:  'PUT',
