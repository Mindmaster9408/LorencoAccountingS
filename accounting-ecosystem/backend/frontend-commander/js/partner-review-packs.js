...
(function () {
    ...
    var BASE = '/api/commander/partner-review-packs';
    var _page = 1;
    ...
    function _loadSummary() {
        window.CommanderAPI.fetch(BASE + '?limit=200')
    ...
    function prpSubmitGenerate(force) {
        ...
        window.CommanderAPI.fetch(BASE + '/generate', {
    ...
    function _renderReportTab(body) {
        ...
        var sm = r.commander_score_movement || {};
    ...
    function prpDownloadPdf() {
        window.CommanderAPI.fetch(BASE + '/' + _currentId + '/report-pdf')
            .then(function (r) {
    ...
    function prpSubmitReject() {
        ...
        window.CommanderAPI.fetch(BASE + '/' + _currentId + '/reject', {
