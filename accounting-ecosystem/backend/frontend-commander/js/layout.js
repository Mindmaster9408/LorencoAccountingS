/* ============================================================
   ...
   (/commander/css/layout.css, confirmed absent from disk — a pre-existing
...
(function () {
    var PAGES = [
        { key: 'dashboard',   label: 'Dashboard',   href: '/commander/index.html' },
        { key: 'management-dashboard', label: 'Management Dashboard', href: '/commander/management-dashboard.html' },
        { key: 'planning-board', label: 'Planning Board', href: '/commander/planning-board.html' },
        { key: 'resource-forecasting', label: 'Resource Forecast', href: '/commander/resource-forecasting.html' },
        { key: 'work-queue', label: 'My Work', href: '/commander/work-queue.html' },
        { key: 'delegation', label: 'Delegation', href: '/commander/delegation.html' },
        { key: 'skills-matrix', label: 'Skills Matrix', href: '/commander/skills-matrix.html' },
        { key: 'learning-centre', label: 'Learning Centre', href: '/commander/learning-centre.html' },
        { key: 'client-success', label: 'Client Success', href: '/commander/client-success.html' },
        { key: 'secretarial', label: 'Secretarial', href: '/commander/secretarial.html' },
        { key: 'secretarial-workflows', label: 'Secretarial Changes', href: '/commander/secretarial-workflows.html' },
        { key: 'secretarial-governance', label: 'Secretarial Governance', href: '/commander/secretarial-governance.html' },
        { key: 'beneficial-ownership', label: 'Beneficial Ownership', href: '/commander/beneficial-ownership.html' },
        { key: 'secretarial-evidence', label: 'Secretarial Evidence', href: '/commander/secretarial-evidence.html' },
        { key: 'secretarial-calendar', label: 'Statutory Calendar', href: '/commander/secretarial-calendar.html' },
        { key: 'entity-lifecycle', label: 'Entity Lifecycle', href: '/commander/entity-lifecycle.html' },
        { key: 'secretarial-integrity', label: 'Secretarial Integrity', href: '/commander/secretarial-integrity.html' },
        { key: 'client-onboarding', label: 'Client Onboarding', href: '/commander/client-onboarding.html' },
        { key: 'engagement-management', label: 'Engagement Management', href: '/commander/engagement-management.html' },
        { key: 'work-authorization', label: 'Work Authorization', href: '/commander/work-authorization.html' },
        { key: 'profitability', label: 'Profitability', href: '/commander/profitability.html' },
        { key: 'pricing-review', label: 'Pricing Reviews', href: '/commander/pricing-review.html' },
        { key: 'partner-scorecards', label: 'Partner Scorecards', href: '/commander/partner-scorecards.html' },
        { key: 'strategic-planning', label: 'Strategic Planning', href: '/commander/strategic-planning.html' },
        { key: 'kpi-history', label: 'KPI History', href: '/commander/kpi-history.html' },
        { key: 'partner-review-packs', label: 'Partner Review Packs', href: '/commander/partner-review-packs.html' },
        { key: 'executive-reporting', label: 'Executive Reporting', href: '/commander/executive-reporting.html' },
        { key: 'automation', label: 'Automation', href: '/commander/automation.html' },
        { key: 'operational-health', label: 'Operational Health', href: '/commander/operational-health.html' },
        { key: 'pilot-readiness', label: 'Pilot Readiness', href: '/commander/pilot-readiness.html' },
        { key: 'alert-rules', label: 'Alert Rules', href: '/commander/alert-rules.html' },
        { key: 'notifications', label: 'Notifications', href: '/commander/notifications.html' },
        { key: 'profile',     label: 'Profile',     href: '/commander/profile.html' },
        { key: 'team',        label: 'Team',        href: '/commander/team.html' },
        { key: 'clients',    label: 'Clients',    href: '/commander/clients.html' },
        { key: 'services',   label: 'Services',   href: '/commander/services.html' },
        { key: 'workflows',  label: 'Workflows',  href: '/commander/workflows.html' },
        { key: 'compliance',  label: 'Compliance',  href: '/commander/compliance.html' },
        { key: 'tasks',       label: 'Tasks',       href: '/commander/tasks.html' },
        { key: 'time',        label: 'Time',        href: '/commander/time.html' },
        { key: 'billing',     label: 'Billing',     href: '/commander/billing.html' },
        { key: 'deadlines',   label: 'Deadlines',   href: '/commander/deadlines.html' },
        { key: 'period-queue', label: 'Period Queue', href: '/commander/engagement-periods.html' },
        { key: 'capacity',      label: 'Capacity',      href: '/commander/capacity.html' },
        { key: 'client-health', label: 'Client Health', href: '/commander/client-health.html' },
        { key: 'reminders',       label: 'Reminders',       href: '/commander/reminders.html' },
        { key: 'communications',  label: 'Communications',  href: '/commander/communications.html' },
        { key: 'documents',         label: 'Documents',         href: '/commander/document-requests.html' },
        { key: 'compliance-packs',   label: 'Compliance Packs',   href: '/commander/compliance-packs.html' },
        { key: 'taxpayer-profiles',  label: 'Taxpayer Profiles',  href: '/commander/taxpayer-profiles.html' },
        { key: 'provisional-tax',    label: 'Provisional Tax',    href: '/commander/provisional-tax.html' },
        { key: 'individual-tax',     label: 'Individual Tax',     href: '/commander/individual-tax.html' },
        { key: 'company-tax',        label: 'Company Tax',        href: '/commander/company-tax.html' },
        { key: 'tax-dashboard',      label: 'Tax Dashboard',      href: '/commander/tax-dashboard.html' },
        { key: 'tax-actions',        label: 'Tax Actions',        href: '/commander/tax-actions.html' },
        { key: 'tax-checklists',     label: 'Tax Checklists',     href: '/commander/tax-checklists.html' },
        { key: 'tax-bulk-ops',       label: 'Tax Bulk Ops',       href: '/commander/tax-bulk-operations.html' },
        { key: 'tax-reports',        label: 'Tax Reports',        href: '/commander/tax-reports.html' },
        { key: 'tax-pipeline',       label: 'Tax Pipeline',       href: '/commander/tax-pipeline.html' },
        { key: 'tax-submissions',    label: 'Tax Submissions',    href: '/commander/tax-submissions.html' },
        { key: 'tax-payments',       label: 'Tax Payments',       href: '/commander/tax-payments.html' },
        { key: 'sars-recon',         label: 'SARS Recon',         href: '/commander/sars-recon.html' },
        { key: 'tax-disputes',        label: 'Tax Disputes',        href: '/commander/tax-disputes.html' },
        { key: 'tax-completion',     label: 'Tax Completion',     href: '/commander/tax-completion.html' },
        { key: 'knowledge-base',     label: 'Knowledge Base',     href: '/commander/knowledge-base.html' },
        { key: 'practice-sop',       label: 'Practice SOPs',      href: '/commander/practice-sop.html' },
        { key: 'quality',            label: 'Quality',            href: '/commander/quality-management.html' },
        { key: 'risk-register',      label: 'Risk Register',      href: '/commander/risk-register.html' },
        { key: 'tax-configs',        label: 'Tax Config',         href: '/commander/tax-configs.html' }
    ];
    ...
    // /commander/css/layout.css resolving) since layout.js is shared by every
    ...
    function _renderBell(activePage) {
        ...
        return '<a href="/commander/notifications.html" title="Notifications" style="position:relative;display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:9px;background:' +
    ...
    function _loadBellCount() {
        if (!window.CommanderAPI || !window.CommanderAPI.fetch) return;
        window.CommanderAPI.fetch('/api/commander/notifications/summary')
    ...
    // LAYOUT.init() link a dead stylesheet path (/commander/css/layout.css,
    ...
    function _applyRoleAwareNav(activePage, groupsEl) {
        if (!window.CommanderAPI || !window.CommanderAPI.fetch) return;
        window.CommanderAPI.fetch('/api/commander/team/me')
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function _injectCosmicBg() {
        ...
        if (!document.getElementById(COSMIC_CSS_ID)) {
            ...
            link.rel = 'stylesheet';
            link.href = '/commander/css/cosmic-bg.css';
        ...
        script.src = '/commander/js/cosmic-bg.js';
    ...
    function init(activePage) {
        ...
        if (topbarEl) {
            ...
            topbarEl.innerHTML =
                '<div class="topbar-left">' +
                    '<img src="/commander/assets/branding/firmflow/firmflow-logo.png" alt="Commander" class="app-icon" style="object-fit:contain;">' +
                    '<div>' +
                        '<div class="app-title">Commander</div>' +
        ...
        // Commander favicon — single injection point covers every practice page
        if (!document.querySelector('link[rel="icon"]')) {
            var favicon = document.createElement('link');
            favicon.rel  = 'icon';
            favicon.type = 'image/png';
            favicon.href = '/commander/assets/branding/firmflow/firmflow-logo.png';
