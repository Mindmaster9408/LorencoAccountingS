(function () {
    ...
    var BASE = '/api/commander/tax-payments';
    ...
    function _renderFooter(d) {
        ...
        var reconUrl = '/commander/sars-recon.html?payment_id=' + encodeURIComponent(d.id) + '&client_id=' + encodeURIComponent(d.client_id);
    ...
    function tprCancelCase() {
        ...
        CommanderAPI.fetch(BASE + '/' + _currentId, { method: 'DELETE' })
            .then(function (r) { return r.json().then(function (d) { return { ok: r.ok, data: d }; }); })
            .then(function (r) {
                _submitting = false;
