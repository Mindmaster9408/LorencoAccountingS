...
(function () {
    ...
    var BASE = '/api/commander/entity-lifecycle';
    ...
    function elLoadClientData() {
        ...
        window.CommanderAPI.fetch(BASE + '/client/' + _currentClientId)
            .then(function (r) { return r.json(); })
            .then(function (d) {
    ...
    function elSaveProfile() {
        ...
        window.CommanderAPI.fetch(BASE + '/client/' + _currentClientId + '/profile', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
    ...
    function elMarkReviewed() {
        window.CommanderAPI.fetch(BASE + '/client/' + _currentClientId + '/profile', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ mark_reviewed: true }) })
            .then(function (r) { return r.json(); })
    ...
    function _loadTransitions() {
        if (!_currentClientId) return;
        window.CommanderAPI.fetch(BASE + '/transitions?client_id=' + _currentClientId)
            .then(function (r) { return r.json(); })
    ...
    function elSubmitNewTransition() {
        ...
        window.CommanderAPI.fetch(BASE + '/transitions', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
    ...
    function elOpenDetail(id) {
        ...
        window.CommanderAPI.fetch(BASE + '/transitions/' + id)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) { _showToast(d.error); return; }
                _renderDetail(d);
    ...
    function elGenerateChecklist(id) {
        window.CommanderAPI.fetch(BASE + '/transitions/' + id + '/generate-checklist', { method: 'POST' })
            .then(function (r) { return r.json(); })
    ...
    function elToggleChecklistItem(id, itemId, completed) {
        window.CommanderAPI.fetch(BASE + '/transitions/' + id + '/checklist/' + itemId, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ completed: completed }) })
            .then(function (r) { return r.json(); })
    ...
    function _loadDetailEvents(id) {
        window.CommanderAPI.fetch(BASE + '/lifecycle_transition/' + id + '/events')
            .then(function (r) { return r.json(); })
            .then(function (d) {
                var rows = d.events || [];
    ...
    function elSubmitReview(id) {
        window.CommanderAPI.fetch(BASE + '/transitions/' + id + '/submit-review', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function elSubmitApprove() {
        ...
        window.CommanderAPI.fetch(BASE + '/transitions/' + id + '/approve', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ override_reason: reason }) })
            .then(function (r) { return r.json(); })
            .then(function (d) {
                if (d.error) {
    ...
    function elSubmitReject() {
        ...
        window.CommanderAPI.fetch(BASE + '/transitions/' + id + '/reject', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ rejection_reason: reason }) })
            .then(function (r) { return r.json(); })
    ...
    function elSubmitImplement() {
        ...
        window.CommanderAPI.fetch(BASE + '/transitions/' + id + '/implement', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ effective_date: effectiveDate }) })
            .then(function (r) { return r.json(); })
    ...
    function elCompleteTransition(id) {
        window.CommanderAPI.fetch(BASE + '/transitions/' + id + '/complete', { method: 'PUT' })
            .then(function (r) { return r.json(); })
    ...
    function elCancelTransition(id) {
        window.CommanderAPI.fetch(BASE + '/transitions/' + id, { method: 'DELETE' })
            .then(function (r) { return r.json(); })
    ...
    function _loadEvents() {
        if (!_currentClientId) return;
        window.CommanderAPI.fetch(BASE + '/events?client_id=' + _currentClientId)
            .then(function (r) { return r.json(); })
            .then(function (d) {
                var rows = d.events || [];
