...
//
// Auth / session / UI preference keys -> native localStorage ONLY.
// KV endpoint: /api/kv
// ============================================================================
    ...
    (function _preload() {
        try {
            ...
            if (xhr.status === 200) {
                ...
                _online = true;
                console.log(
                    '%c\u2601\ufe0f  Paytime POS \u2014 all data in Supabase (zero local storage)',
            ...
            console.warn('\u26a0\ufe0f  Cloud storage preload failed (Paytime POS):', e.message);
        }
    }());
